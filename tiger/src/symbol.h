...
/** S_table is a mapping from S_symbol->any, where "any" is represented here by void* */
typedef struct TAB_table_* S_table;

/** Make a new table */
S_table S_empty(void);

/** Enter a binding "sym->value" into "t", shadowing but not deleting any previous binding of "sym". */
void S_enter(S_table t, S_symbol sym, void* value);

/** Look up the most recent binding of "sym" in "t", or return NULL if sym is unbound. */
